    ...
    <div class="stack">
        ...
        <div class="as-search-wrapper" role="main">
            ...
            <div class="as-search-results as-filter-open as-category-landing as-desktop" id="as-search-results">
                ...
                <span>id del pago: <?php echo $_GET["collection_id"] ?></span> <br>
                <span>Referencia: <?php echo $_GET["external_reference"] ?></span> <br>
                <span>id de la preferencia: <?php echo $_GET["preference_id"] ?></span> <br>
                <span>id del sitio: <?php echo $_GET["site_id"] ?> </span> <br>
